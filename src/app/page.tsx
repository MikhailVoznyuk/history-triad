...
export default function Home() {
    ...
    const PORTRAITS = useMemo(() => [
        ...
        'persons/martyanich/portrait.webp'
    ], []);
    ...
    const PERSON_HEADERS = useMemo<Array<PersonData>>(() => [
        ...
        {fullName: 'Петр Николаевич Мартьянов', description: 'Владелец ресторана «Мартьяныч», который сумел превратить подвальный зал Верхних торговых рядов в одно из самых узнаваемых мест городской Москвы начала XX века. Он сделал ставку на редкое для своего времени сочетание: широкий выбор и качественная кухня при демократичных ценах, понятных студентам и городской публике. Но решающим стало другое: «Мартьяныч» работал не только как ресторан, а как пространство впечатлений и общения, где реклама создавала легенду, а сами залы становились сценой для тематических вечеров и общих городских ритуалов.'}
    ], [])
