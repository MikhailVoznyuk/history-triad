...
const NavItem = forwardRef<HTMLDivElement, NavItemProps>((props: NavItemProps, ref) => {
    return (
        <div ref={ref} className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 cursor-pointer" onClick={props.onSelect}
        >
            <div className="hover-scale">
                <div className="relative size-[50px] sm:size-[80px]  origin-center overflow-hidden rounded-[50%] border-2"
